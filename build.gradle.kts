...
bukkit {
    ...
    commands {
        ...
        register("placedigitalclock") {
            description = "デジタル時計を設置します。"
            usage = "/placedigitalclock [delete]"
            permission = "otanoshimi.command.placedigitalclock"
        }
    ...
    permissions {
        ...
        register("otanoshimi.command.placedigitalclock") {
            default = Permission.Default.OP
        }
