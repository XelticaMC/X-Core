...
public enum Hint {
    ...
    GOTO_WILDAREA("資源調達に行くぞ！", "ロビーからワイルドエリアAへ行く。ワイルドエリアAは普通のサバイバル・資源採取に自由に使えるワールド。", 100),
    GOTO_WILDAREAB("広大な自然へ…", "X Phoneのテレポートアプリを用いて、メインワールドからワイルドエリアBに行く。ワイルドエリアBはAと異なり、月に1回再生成があるぞ。", 100),
    GOTO_WILDNETHER("怖い地底世界", "ワイルドエリアAでネザーポータルを作り、行く。作り方は知ってるよね？", 100),
    GOTO_WILDEND("はて？ここは果て？", "ワイルドエリアAでエンド要塞を見つけ、行く。要塞の意味は知ってるよね？", 100),
    ...
    QUICKCHAT_APP("クイックチャット", "X Phoneアプリ「クイックチャット」を使って簡単にメッセージを送ろう！", 100),
    QUICKCHAT("点から始まるコミュニケーション", "X Phoneアプリ「クイックチャット」のメニューにかかれている英文字をチャットに打ち込もう。例: .k → こんにちは", 100),
    ...
    WHAT_TO_DO("やることがない", "やることに困ったら、まずはワイルドエリアAで資源集めをしましょう。その後、メインワールドに戻って、トロッコを使って電車に乗り、好きな場所にお家を建てましょう。"),

    // イベント限定
    TAIKO("太鼓の○人", "【イベント】夏祭りイベント会場のやぐらにある太鼓に矢を当てて鳴らす。", 500),
    BUY_FIREWORKS("花火師", "【イベント】X Phoneで花火を購入しよう。", 500),
    FIREWORKS("たまや～！", "【イベント】花火を打ち上げよう！花火はみんなそれぞれ違う柄だから、集まって打ち上げるともっと盛り上がるぞ！", 500),
    ;
