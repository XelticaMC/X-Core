...
public class MenuItem {
    ...
    public MenuItem(String name, Consumer<MenuItem> onClick, Material icon, Object customData, int count, boolean shiny) {
        this(name, onClick, new ItemStack(icon), customData, count, shiny);
    }
    ...
    public MenuItem(String name, Consumer<MenuItem> onClick, ItemStack icon, Object customData, int count) {
        this(name, onClick, icon, customData, count, false);
    }

    public MenuItem(String name, Consumer<MenuItem> onClick, ItemStack icon, Object customData, int count, boolean shiny) {
        this.name = name;
